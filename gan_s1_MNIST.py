...
split1, _ = torch.utils.data.random_split(data, [30000, 30000])
    
if __name__ == "__main__":

    train_dataloader = torch.utils.data.DataLoader(split1, batch_size=256, num_workers=4, shuffle=True, drop_last=True)
